...
// single unit called class. In Encapsulation, the data is not accessed directly;
// it is accessed through the functions present inside the class.
// In simpler words, attributes of the class are kept private and public getter and setter methods
// are provided to manipulate these attributes. Thus, encapsulation makes the concept of
